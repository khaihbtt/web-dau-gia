                        ...
                        <nav class="catergory">
                            ...
                            <ul class="catergory-list">
                                 <li class="catergory-item">
                                    <a href="quanly.php" class="catergory-item__link catergory-item__link--active">Sản phẩm đang đấu</a>
                                </li>
                                <li class="catergory-item">
                                    <a href="suathongtin.php" class="catergory-item__link">Sửa thông tin</a>
                                </li>
                                <li class="catergory-item">
                                    <a href="dadau.php" class="catergory-item__link">Sản phẩm đã đấu</a>
                                </li>
                        ...
                        <div class="product">
                            <div class="grid__row ">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM product WHERE deleted = 1 AND Tinhtrang = 1 ORDER BY Giahientai ASC";
                                    $kq =$conn->query($sql);
                                    ...
                                    foreach($kq as $item){
                                        ...
                                        <div class="grid_columm-2-4">
                                            <div class="product__item">
                                                ...
                                                <div class="btn-join">
                                                    <a href="ketthuc.php?Id='.$item['Id'].'" class="btn-join__link"><button class="btn btn-sua"  style = "height: 36px;
                                                    width: 70px;
                                                    outline: none;
                                                    padding-left: 20px;
                                                    padding-right: 20px;
                                                    ...
                                                    border-radius: 3px;
                                                    transition: 0.25s;
                                                    opacity: 1;">Kết thúc</button></a>

                                                    <button class="btn btn-xoa" onclick= "deleted('.$item['Id'].')" style = "height: 36px;
                                                    width: 70px;
                                                    margin-top:10px;
                                                    outline: none;
                                                    padding-left: 20px;
