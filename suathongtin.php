                    ...
                    <div class="grid__columm-2">
                        <nav class="catergory">
                            ...
                            <ul class="catergory-list">
                                ...
                                <li class="catergory-item">
                                    <a href="suathongtin.php" class="catergory-item__link catergory-item__link--active">Sửa thông tin</a>
                                </li>
                                <li class="catergory-item">
                        ...
                        <div class="product">
                            <div class="grid__row ">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM product WHERE deleted = 1 AND Tinhtrang = 1";
                                    $kq =$conn->query($sql);
                                    ...
                                    foreach($kq as $item){
                                        ...
                                        <div class="grid_columm-2-4">
                                            <div class="product__item">
                                                ...
                                                <div class="btn-join">
                                                    <a href="chinhsua.php?Id='.$item['Id'].'" class="btn-join__link"><button class="btn btn-sua"  style = "height: 36px;
                                                    width: 70px;
                                                    outline: none;
                                                    padding-left: 20px;
                                                    padding-right: 20px;
