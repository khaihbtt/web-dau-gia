...
<head>
    ...
    <link rel="stylesheet" href="./assest/css/gia_cao.css">
                ...
                <div class="grid__row app_content">
                    ...
                    <div class="grid__columm-10">
                        ...
                        <div class="home-filter">
                            ...
                            <a href="offical.php" class=""><button class="btn btn-cao">Giá tổng hợp</button></a>
                            <a href="gia_cao.php" class=""><button class="btn btn-re btn-re--active">Giá cao</button></a>
                        ...
                        <div class="product">
                            <div class="grid__row ">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM product WHERE deleted = 1 AND Giahientai > 1000000";
                                    $kq =$conn->query($sql);
                                    ...
                                    foreach($kq as $item){
                                        ...
                                        <div class="grid_columm-2-4">
                                            <div class="product__item">
                                                ...
                                                <div class="btn-join">
                                                    <a href="chi_tiet.php?Id='.$item['Id'].'" class="btn-join__link"><button class="btn btn-vao">Vào đấu</button></a>
                                                </div>
                                            </div>
                                    </div>';
                                    }
